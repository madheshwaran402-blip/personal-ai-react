      ...
      <div className="hero-content">
        ...
        <div className="hero-text">
          ...
          <p className="hero-bio">
            Engineering student from Tamil Nadu building FPGA-based deterministic systems
            and neuromorphic-inspired hardware. Creator of Determinex — winner of IDEATHON 1.0.
          </p>
          <div className="hero-links">
            ...
            <a href="#chat" className="hero-btn primary">Chat with my AI ↗️</a>
          </div>
        </div>
      </div>
    </section>
